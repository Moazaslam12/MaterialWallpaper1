...
public class ActivityWallpaperDetail extends AppCompatActivity {
    ...
    private void updateDownload(String image_id) {
        ApiInterface apiInterface = RestAdapter.createAPI();
    ...
    private void loadUnityBannerAd() {
        bottomBanner = new BannerView(ActivityWallpaperDetail.this, adsPref.getUnityBannerPlacementId(), new UnityBannerSize(UNITY_ADS_BANNER_WIDTH, UNITY_ADS_BANNER_HEIGHT));
    ...
    private void loadInterstitialAdNetwork() {
        if (adsPref.getAdStatus().equals(AD_STATUS_ON) && adsPref.getAdType().equals(ADMOB)) {
            if (adsPref.getInterstitialAdDetail() != 0) {
                adMobInterstitialAd = new InterstitialAd(ActivityWallpaperDetail.this);
                adMobInterstitialAd.setAdUnitId(adsPref.getAdMobInterstitialId());
                adMobInterstitialAd.loadAd(Tools.getAdRequest(ActivityWallpaperDetail.this));
            ...
            if (adsPref.getInterstitialAdDetail() != 0) {
                if (BuildConfig.DEBUG) {
                    fanInterstitialAd = new com.facebook.ads.InterstitialAd(ActivityWallpaperDetail.this, "IMG_16_9_APP_INSTALL#" + adsPref.getFanInterstitialUnitId());
                } else {
                    fanInterstitialAd = new com.facebook.ads.InterstitialAd(ActivityWallpaperDetail.this, adsPref.getFanInterstitialUnitId());
                }
            ...
            if (adsPref.getInterstitialAdDetail() != 0) {
                startAppAd = new StartAppAd(ActivityWallpaperDetail.this);
            }
        }
    }
            ...
            if (adsPref.getAdStatus().equals(AD_STATUS_ON) && adsPref.getAdType().equals(ADMOB)) {
                ...
                if (adsPref.getInterstitialAdDetail() != 0) {
                    if (UnityAds.isReady(adsPref.getUnityInterstitialPlacementId())) {
                        UnityAds.show(ActivityWallpaperDetail.this, adsPref.getUnityInterstitialPlacementId());
                    }
                }
            }
        }, Constant.DELAY_ADS);
